...
var catListView = {
	init: function() {
		...
		//render this view (update teh DOM elements with the right values)
		this.render();
	},
	...
	render: function() {
		...
		//Let's loop over in the array
		for (var i = 0; i < cats.length; i++) {
			//This is the number that we are currently on
			var cat = cats[i];
			//Make a cat list item and its text
			elem = document.createElement('li');
			elem.textContent = cat.name;

			//On click, setCurrentCat and render catView
			//This uses closure-in-a-loop trick to connect to the value 
			...
			//Finally, add the elment to the list
...
var catView = {
	...
	init: function() {
		//store pointers to out DOM elements for easy access later
...
render: function() {
	//Update teh DOM elements with values from the current cat
	...
	this.catImageElem.textContent = selectedCat.image;
